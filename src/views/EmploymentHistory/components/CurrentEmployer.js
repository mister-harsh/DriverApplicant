      ...
      <React.Fragment>
        <Box className={classes.container} component="div">
          <Typography
            ...
            color="secondary"
            variant="h4">
            Current or Most Recent Employer / Truck Driving School
          </Typography>
        ...
        <Box className={clsx(classes.container, classes.addJobContainer)} component="div">
          <Typography
            component="p"
            align='center'
            className={clsx(classes.dangerText, classes.inlineP)}
            variant="subtitle1">
            I do not have any more jobs to add.
          </Typography>
...
CurrentEmployer.propTypes = {
  className: PropTypes.string
};

CurrentEmployer.defaultProps = {};
